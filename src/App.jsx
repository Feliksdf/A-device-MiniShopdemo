    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <style jsx>{`
        ...
        .no-scrollbar {
          ...
          useEffect(() => {
  fetch('https://your-firebase.firebaseio.com/products.json ')
    .then(res => res.json())
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Контент магазина */}
      <h1 className="text-3xl font-bold text-center mt-6">A-Device</h1>
      <p className="text-center opacity-70 mt-1">Оригинальная техника Apple и аксессуары</p>

      {/* Поиск */}
      <div className="mb-6 mt-6 px-4 max-w-3xl mx-auto w-full">
        <input
          type="text"
          placeholder="Поиск товаров..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="w-full px-4 py-2 rounded bg-gray-900 border-gray-700 border focus:outline-none focus:ring-2 focus:ring-gray-500"
        />
      </div>
